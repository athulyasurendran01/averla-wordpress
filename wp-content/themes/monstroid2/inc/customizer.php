	...
	return apply_filters( 'monstroid2_get_customizer_options' , array(
		...
		'options'    => array(
			...
			'maintenance_mode' => array(
				'title'    => esc_html__( 'Maintenance mode', 'monstroid2' ),
				'priority' => 60,
				'type'     => 'section',
				'panel'    => 'general_settings',
			),
			...
			'maintenance_mode_enable' => array(
				'title'    => esc_html__( 'Enable Maintenance Mode', 'monstroid2' ),
			...
			'maintenance_mode_page' => array(
				'title'       => esc_html__( 'Maintenance page', 'monstroid2' ),
				'description' => esc_html__( 'Select page that regular visitors will see if maintenance mode is enabled.', 'monstroid2' ),
				'section'     => 'maintenance_mode',
				'default'     => '',
				'field'       => 'select',
				'choices'     => monstroid2_get_maintenance_pages(),
				'type'        => 'control',
			),
			...
			'header_btn_target' => array(
				'title'           => esc_html__( 'Open Link in New Tab', 'monstroid2' ),
				'section'         => 'header_elements',
				'default'         => false,
				'field'           => 'checkbox',
				'type'            => 'control',
			...
			/** `StickUp` section */
			'header_stickup' => array(
				'title'       => esc_html__( 'StickUp Mode', 'monstroid2' ),
				'description' => esc_html__( 'This option is available only for Desktop and Laptop devices.', 'monstroid2' ),
				'priority'    => 20,
				'panel'       => 'header_options',
				'type'        => 'section',
			),
			'header_menu_sticky' => array(
				'title'   => esc_html__( 'Enable sticky mode', 'monstroid2' ),
				'section' => 'header_stickup',
				'default' => false,
				'field'   => 'checkbox',
				'type'    => 'control',
			),
			'sticky_target' => array(
				'title'   => esc_html__( 'Sticky target', 'monstroid2' ),
				'section' => 'header_stickup',
				'default' => 'menu_only',
				'field'   => 'radio',
				'choices' => array(
					'header'             => esc_html__( 'Header', 'monstroid2' ),
					'menu_only'          => esc_html__( 'Menu Only', 'monstroid2' ),
					'logo_only'          => esc_html__( 'Logo Only', 'monstroid2' ),
					'logo_and_menu_only' => esc_html__( 'Menu & Logo Only', 'monstroid2' ),
				),
				'type'            => 'control',
				'active_callback' => 'monstroid2_is_sticky_mode',
			),
			...
			'google_analytics' => array(
				'title'    => esc_html__( 'Google Analytics', 'monstroid2' ),
				'priority' => 110,
				'type'     => 'section',
			),

			'google_analytics_code' => array(
				'title'             => esc_html__( 'Google Analytics Code', 'monstroid2' ),
				'description'       => esc_html__( 'You can paste your Google Analytics or other tracking code in this box. This will be automatically added to the footer.', 'monstroid2' ),
...
/**
 * Return true if Sticky mode was enabled. Otherwise - return false.
 *
 * @param  object $control Parent control.
 * @return bool
 */
function monstroid2_is_sticky_mode( $control ) {
	return monstroid2_is_setting( $control, 'header_menu_sticky', true );
}
...
function monstroid2_get_skins_style_settings() {
	return apply_filters( 'monstroid2_skins_style_options', array(
		...
		'skin14' => array(
			'label'       => esc_html__( 'Ollnew', 'monstroid2' ),
			'url'         => trailingslashit( MONSTROID2_THEME_URI ) . 'skins/skin14/style-skin14.css',
			'dynamic_dir' => trailingslashit( MONSTROID2_THEME_DIR ) . 'skins/skin14/assets/css/dynamic-skin14.css',
		),
		'skin15' => array(
			'label'       => esc_html__( 'ShowPage', 'monstroid2' ),
			'url'         => trailingslashit( MONSTROID2_THEME_URI ) . 'skins/skin15/style-skin15.css',
			'dynamic_dir' => trailingslashit( MONSTROID2_THEME_DIR ) . 'skins/skin15/assets/css/dynamic-skin15.css',
		),
		'skin16' => array(
			'label'       => esc_html__( 'Reflax', 'monstroid2' ),
			'url'         => trailingslashit( MONSTROID2_THEME_URI ) . 'skins/skin16/style-skin16.css',
			'dynamic_dir' => trailingslashit( MONSTROID2_THEME_DIR ) . 'skins/skin16/assets/css/dynamic-skin16.css',
		),
	) );
}
...
function monstroid2_get_dynamic_css_options() {
	return apply_filters( 'monstroid2_get_dynamic_css_options', array(
		...
		'css_files'     => array(
			...
			MONSTROID2_THEME_DIR . '/assets/css/dynamic/plugins/cherry-search.css',
 ...
 * @return array
 */
function monstroid2_get_maintenance_pages() {
	$pages     = array();
	$pages_obj = get_pages();

	$pages[''] = esc_html__( 'Select a page:', 'monstroid2' );
