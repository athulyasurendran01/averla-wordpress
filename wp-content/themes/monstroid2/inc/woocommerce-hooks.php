...
add_action( 'woocommerce_before_subcategory_title', 'monstroid2_woocommerce_subcategory_thumbnail', 10, 2 );
...
add_action( 'woocommerce_after_subcategory', 'monstroid2_woocommerce_template_loop_category_title', 10 );
...
add_action( 'woocommerce_after_single_product_summary', 'monstroid2_woocommerce_output_related_products', 20 );
...
add_action( 'tm_smart_box_woocommerce_before_shop_loop_item_title', 'monstroid2_woocommerce_template_loop_product_thumbnail_custom_size', 10 );
...
add_action( 'woocommerce_cart_collaterals', 'monstroid2_woocommerce_cross_sell_display', 12 );
