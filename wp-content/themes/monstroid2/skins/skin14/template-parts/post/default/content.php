...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'posts-list__item card' ); ?>>
	...
	<?php if ( 'small' === $blog_featured_image && has_post_thumbnail() ) : ?>
		...
		<figure class="post-thumbnail">
			<?php get_template_part( 'skins/skin14/template-parts/content-entry-meta-loop-cats' ) ?>
			...
			<div class="content-wrapper">
				<header class="entry-header">
					<?php if ( !has_post_thumbnail() ) :
						get_template_part( 'skins/skin14/template-parts/content-entry-meta-loop-cats' );
					endif; ?>
				...
				<?php get_template_part( 'skins/skin14/template-parts/content-entry-meta-loop' ) ?>
